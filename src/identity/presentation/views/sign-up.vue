...
.login-page { display: flex; min-height: 100vh; background: #b0356d; color: #fff; align-items: center; justify-content: center; gap: 40px; padding: 40px; box-sizing: border-box; }
...
.discover { font-size: 40px; font-weight: 300; line-height: 1.2; margin: 0 0 28px 0; color: #fff; max-width: 90%; }
.info-btn { background: #2e2e2e; color: #fff; border: 4px solid #000; padding: 14px 36px; font-size: 24px; width: 420px; max-width: 85%; border-radius: 10px; cursor: pointer; }
.login-right { width: 480px; display: flex; align-items: center; justify-content: center; }
.login-card { background: #3a3737; color: #fff; padding: 32px; width: 100%; border: 4px solid #000; box-sizing: border-box; }
.login-card h2 { font-size: 36px; margin: 0 0 16px 0; }
.login-card .sub { font-size: 20px; margin-bottom: 18px; }
.input-label { display: block; margin-top: 12px; color: #ddd; font-size: 18px; }
.text-input { width: 100%; padding: 14px; margin-top: 6px; font-size: 20px; box-sizing: border-box; border: none; background: #e6e6e6; color: #333; }
.ingresar-btn { margin-top: 20px; width: 100%; background: #b0356d; color: #000; padding: 14px; font-size: 28px; border: 2px solid #000; cursor: pointer; }
.forgot-btn { margin-top: 8px; width: 100%; background: transparent; color: #fff; border: none; font-size: 16px; cursor: pointer; text-decoration: underline; }
.link-btn { margin-top: 12px; background: transparent; color: #fff; border: none; font-size: 18px; cursor: pointer; }
